...
This section transparently documents current flaws, rough edges, and unimpressive aspects of Vellium as it stands today. The app is functional but still pre-1.0 (`v0.9.x`), and these limitations should be understood before adopting it for serious workflows.
